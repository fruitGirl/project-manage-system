/*
 * @Description: 项目-关联用例-按套件关联
 * @Author: moran
 * @Date: 2019-06-21 18:16:08
 * @Last Modified by: moran
 * @Last Modified time: 2019-08-29 19:00:28
 */
...
<template>
  <div v-loading="useCaseLoading">
    ...
    <other-relate-search
      ...
      :search-action="TEST_SUITE_NAME_URL"
      field-text="testSuiteList"
      placeholder="请输入套件名称查询"
      @change="handleSubmit"
    ></other-relate-search>
    <pm-table
      :data="testCasePage"
