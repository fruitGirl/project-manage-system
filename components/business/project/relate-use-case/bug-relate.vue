...
import { TEST_CASE_STATUS_URL, BUG_NAME_URL } from '@/services/common-config';
    ...
    handleSubmit(item) {
      this.formDatas = item
        ? {
            ...
            ...this.formDatas,
            ...item.needFileds,
            bugIds: item.demandIds
          }
        : { ...this.pagination, ...this.formDatas };
