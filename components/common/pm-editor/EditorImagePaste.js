/*
 * @Description: 上传图片-粘贴功能
 * @Author: danding
 * @Date: 2019-07-24 17:43:13
 * @Last Modified by: danding
 * @Last Modified time: 2019-07-24 17:43:13
 */

export class EditorImagePaste {
  /**
  ...
  constructor(quill, options = {}) {
    ...
    this.handleCustomUpload = handleCustomUpload;
  ...
  readFiles(files, callback) {
    ...
    [].forEach.call(files, file => {
      ...
      this.handleCustomUpload({ file: blob });
