 ...
 * @Last Modified time: 2019-11-05 16:05:11
 */
<template>
        ...
        <div class="left">
          ...
          >
            ...
            <test-form
              ...
              :product-id="$route.query.dependenceId"
            />
...
const { mapActions, mapState } = createNamespacedHelpers('test/editor-test');
      ...
      this.$refs.editor.validate(valid => {
        if (valid && formData) {
          ...
          this.testFormModify({ ...testFormDatas, id: formId });
            ...
            this.testFormCreate({ ...testFormDatas, testCaseIdList });
          }
        }
      });
    },
